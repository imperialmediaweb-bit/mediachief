<div class="border-b border-brand-border bg-brand-darker">
    <div class="mx-auto max-w-7xl px-4">
        <div class="flex h-9 items-center justify-between text-xs">
            ...
            <div class="flex items-center gap-3">
                <a href="#" class="text-brand-text-muted hover:text-white" aria-label="Facebook">
                ...
                <a href="#" class="text-brand-text-muted hover:text-white" aria-label="X / Twitter">
                ...
                <a href="#" class="text-brand-text-muted hover:text-white" aria-label="Instagram">
