    ...
    <div class="mx-auto max-w-7xl px-4">
        <div class="flex h-9 items-center justify-between text-xs">
            <div class="flex items-center gap-4 text-gray-500">
                <span>{{ now()->translatedFormat('l, F d, Y') }}</span>
            </div>
            <div class="flex items-center gap-3">
                <a href="#" class="text-gray-400 hover:text-brand-red" aria-label="Facebook">
                ...
                <a href="#" class="text-gray-400 hover:text-brand-red" aria-label="X / Twitter">
                ...
                <a href="#" class="text-gray-400 hover:text-brand-red" aria-label="Instagram">
