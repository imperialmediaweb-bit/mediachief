...
if [ "$DB_READY" = true ]; then
    ...
    # Import WordPress theme CSS (if site has a wordpress_url)
    echo "Importing WordPress theme CSS..."
    timeout 60 php artisan wp:import-theme-css 2>&1 || echo "Theme CSS import skipped or failed"
